...
## Windows version
docker run --rm --network mynetwork confluentinc/cp-kafka:6.1.4 kafka-topics --create --topic test --partitions 3 --replication-factor 3 --if-not-exists --bootstrap-server kafka-1:29092,kafka-2:39092,kafka-3:49092
...
## Windows version
docker run --network mynetwork --rm confluentinc/cp-kafka:6.1.4 kafka-topics --describe --topic test --bootstrap-server kafka-1:29092,kafka-2:39092,kafka-3:49092
