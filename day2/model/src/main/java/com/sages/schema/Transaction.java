...
public class Transaction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6444176954441790756L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transaction\",\"namespace\":\"com.sages.schema\",\"fields\":[{\"name\":\"transactionId\",\"type\":\"long\"},{\"name\":\"transactionValue\",\"type\":\"double\"},{\"name\":\"description\",\"type\":\"string\"}]}");
   ...
   */
  public Transaction(java.lang.Long transactionId, java.lang.Double transactionValue, java.lang.CharSequence description) {
   ...
   */
  public static com.sages.schema.Transaction.Builder newBuilder() {
    return new com.sages.schema.Transaction.Builder();
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.sages.schema.Transaction.Builder newBuilder(com.sages.schema.Transaction.Builder other) {
    if (other == null) {
      return new com.sages.schema.Transaction.Builder();
    } else {
      return new com.sages.schema.Transaction.Builder(other);
    }
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.sages.schema.Transaction.Builder newBuilder(com.sages.schema.Transaction other) {
    if (other == null) {
      return new com.sages.schema.Transaction.Builder();
    } else {
      return new com.sages.schema.Transaction.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transaction>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sages.schema.Transaction.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sages.schema.Transaction other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sages.schema.Transaction.Builder setTransactionId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sages.schema.Transaction.Builder clearTransactionId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sages.schema.Transaction.Builder setTransactionValue(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sages.schema.Transaction.Builder clearTransactionValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sages.schema.Transaction.Builder setDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sages.schema.Transaction.Builder clearDescription() {
      description = null;
